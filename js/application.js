...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>查看帳戶詳細資訊</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>在 Twitter 上查看個人檔案</a></li></ul>'),
    modal_header: Hogan.compile('<h3>帳戶細節 <span class="download-date muted">於 {{created_at_relative}}</span></h3>'),
    ...
    modal_payload_details: Hogan.compile('<p>{{tweets}} <span class="footer-label muted">則推文</span></p>'),
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">使用者 ID</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">加入</span></p>'),
    ...
    singular_tweet_count: Hogan.compile('{{count}} 則推文'),
    plural_tweet_count: Hogan.compile('{{count}} 則推文')
  };
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', '你的查詢必須包含最少2個字')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', '搜尋所有推文');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "你的 Twitter 封存檔";
      $('#footer-text').append("這離線封存檔存有你在 Twitter 上所發的推文。請使用以上所列出的月份瀏覽這存檔。");
      var compose_new_tweet = "撰寫新推文";
